...
\begin{enumerate}
    ...
    Let $I_1,..I_n$ be the set of objects ordered by non-increasing value of cost ratio: $v_i / c_i$
    ...
    \begin{itemize}
        \item $p_j$ is just the most of item $I_j$ we can currently afford with the leftover budget ($U'[j - i]$)
