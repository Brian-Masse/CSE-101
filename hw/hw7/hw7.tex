...
\begin{itemize}
    ...
    \item The solutions to each subproblem can be stored in an array, $TravelPenalty[]$, of length $n$, where $TravelPenalty[i] = $ the minimum penalty to reach this hotel; this penalty is the minimum sum for all travel days taken after hotel $a_i$. 
